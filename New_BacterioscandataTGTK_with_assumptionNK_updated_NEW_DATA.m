...
Final_values(1,1) = 0.447535814068696;
Final_values(2,1) = 0.0916663695530375;
Final_values(3,1) = 1.86827676426305;

xq1(1) = 10^6.121403527;
...
% Final_values(1,2) = 3.11771794932434;% NTOTAL ONLY DATA 
% Final_values(2,2) = 0.350406238036801;% NTOTAL ONLY DATA 
% Final_values(3,2) = 1.91376242899743;% NTOTAL ONLY DATA 
% 
% xq1(2) =  1.1824e+06;
% 
...
% Final_lambda(2) = Final_values(3,2);
 ...
 %% C=16_8
% 
Final_values(1,3) = [8.65735748273705];
Final_values(2,3) = [0.157658020735161];
Final_values(3,3) = [10.5105347156774];

xq1(3) = 10^6.154033559;
...
% 
 %% C=64_32
% 
Final_values(1,4) = [23.0424801872451];
Final_values(2,4) = [0.866312479804285];
Final_values(3,4) = [3.15485015770326];
...
Final_values(2,5) = 120;
Final_values(3,5) = 3.64169999999999 ;

xq1(5) = 10^6.162064308;
